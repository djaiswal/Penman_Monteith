...
sheet_name = 'Sheet1'
output_filename = r'Fig4\avg_annual_eto_ssp126_large_font.png'
...
# --- Save and Show ---
fig.text(0.03, 0.99, '(a)', ha='center', va='top', fontsize=main_font_size, fontweight='bold')
fig.suptitle('Scenario : SSP1-2.6', fontsize=main_font_size, fontweight='bold')
plt.savefig(output_filename, dpi=300, bbox_inches='tight')
print(f"Plot saved as {output_filename}")
plt.show()

# r"D:\CO2 Paper\Results_units_corrected\ssp585\annual_avg_eto_ssp585\ssp585_all_gcms_annual_avg.xlsx"